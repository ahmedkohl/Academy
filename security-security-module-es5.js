...
var RolesClaimsComponent = /** @class */ (function () {
    function RolesClaimsComponent(service, dialogRef, data, notify) {
    ...
    RolesClaimsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.service.getRoleClaims(this.data.Id).subscribe(function (res) {
            _this.service.basicDataClaimsList = res.Cliams.filter(function (a) { return a.ClaimFlag == "basicData"; });
            _this.service.PointsClaimList = res.Cliams.filter(function (a) { return a.ClaimFlag == "Points"; });
            _this.service.ReservationClaimList = res.Cliams.filter(function (a) { return a.ClaimFlag == "Reservation"; });
            _this.service.securityClaimList = res.Cliams.filter(function (a) { return a.ClaimFlag == "Security"; });
            _this.service.InvoiceClaimList = res.Cliams.filter(function (a) { return a.ClaimFlag == "Invoice"; });
            _this.service.ReportsClaimList = res.Cliams.filter(function (a) { return a.ClaimFlag == "Reports"; });
        });
    };
    RolesClaimsComponent.prototype.selectALLbasicData = function (ctrl) {
        if (ctrl.target.checked) {
            this.service.basicDataClaimsList.forEach(function (element) {
    ...
    RolesClaimsComponent.prototype.onSubmit = function () {
        var _this = this;
        var body = {
            RoleId: this.data.Id,
        ...
        this.service.postRoleClaims(body).subscribe(function (res) {
            _this.notify.success("تم التعديل بنجاح");
            _this.dialogRef.close();
        });
    };
    RolesClaimsComponent.prototype.onClose = function () {
        this.dialogRef.close();
    };
    RolesClaimsComponent.ctorParameters = function () { return [
...
var RolesFormComponent = /** @class */ (function () {
    function RolesFormComponent(fb, service, dialogRef, data, notify) {
        this.fb = fb;
        this.service = service;
        this.dialogRef = dialogRef;
        this.data = data;
    ...
    RolesFormComponent.prototype.ngOnInit = function () {
        ...
        if (this.data.Id == null) {
            ...
            this.service.getOneRole(this.data.Id).subscribe(function (res) {
                _this.service.rolesForm.setValue({
                    Id: res.Id,
                    RoleName: res.Name
                });
            });
    ...
    Object.defineProperty(RolesFormComponent.prototype, "f", {
        get: function () {
    ...
    RolesFormComponent.prototype.onClose = function () {
    ...
    RolesFormComponent.prototype.onSubmit = function () {
        ...
        if (this.service.rolesForm.invalid) {
            ...
            var body = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this.service.rolesForm.value);
            if (this.data.Id == null) {
                this.service.postRole(body).subscribe(function (res) {
                    _this.notify.success('تمت الاضافه بنجاح');
                    _this.dialogRef.close();
                });
            }
            else {
                this.service.PutRole(this.data.Id, body).subscribe(function (res) {
                    _this.notify.success('تم التعديل بنجاح');
                    _this.dialogRef.close();
                });
            }
    ...
    RolesFormComponent.ctorParameters = function () { return [
...
var RolesListComponent = /** @class */ (function () {
    function RolesListComponent(service, route, dialog) {
        this.service = service;
        this.route = route;
        this.dialog = dialog;
    ...
    RolesListComponent.prototype.getAllROLes = function () {
        var _this = this;
        this.service.getAllRoles().subscribe(function (res) {
            _this.listData = new _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](res);
    ...
    RolesListComponent.prototype.onCreateOrEdit = function (Id) {
        var _this = this;
        ...
        this.dialog.open(_roles_form_roles_form_component__WEBPACK_IMPORTED_MODULE_4__["RolesFormComponent"], dialogConfig).afterClosed().subscribe(function (res) {
            _this.getAllROLes();
        });
    };
    RolesListComponent.prototype.onShow = function (Id) {
        var _this = this;
        var dialogConfig = new _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatDialogConfig"]();
        dialogConfig.autoFocus = true;
        dialogConfig.disableClose = true;
        dialogConfig.width = "70%";
        dialogConfig.data = { Id: Id };
        this.dialog.open(_roles_claims_roles_claims_component__WEBPACK_IMPORTED_MODULE_5__["RolesClaimsComponent"], dialogConfig).afterClosed().subscribe(function (res) {
            _this.getAllROLes();
        });
    };
...
var UsersRolesFormComponent = /** @class */ (function () {
    function UsersRolesFormComponent(service, dialogRef, data, serviceRoles, notify) {
        this.service = service;
        this.dialogRef = dialogRef;
        this.data = data;
    ...
    UsersRolesFormComponent.prototype.ngOnInit = function () {
    ...
    Object.defineProperty(UsersRolesFormComponent.prototype, "f", {
        get: function () {
    ...
    UsersRolesFormComponent.prototype.onClose = function () {
        this.service.userRolesForm.reset();
        this.dialogRef.close();
    };
    UsersRolesFormComponent.prototype.onSubmit = function () {
        var _this = this;
        this.submitted = true;
        if (this.service.userRolesForm.invalid) {
            ...
            var body = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this.service.userRolesForm.value);
            console.log(body);
            this.service.putRoles(body).subscribe(function (res) {
                _this.notify.success('تم التعديل بنجاح');
                _this.service.userRolesForm.reset();
                _this.dialogRef.close();
            });
        }
    };
    UsersRolesFormComponent.ctorParameters = function () { return [
    ...
    return UsersRolesFormComponent;
}());
...
var UsersRolesListComponent = /** @class */ (function () {
    function UsersRolesListComponent(service, route, dialog) {
        this.service = service;
        this.route = route;
        this.dialog = dialog;
        this.displayedColumns = ['UserName', "Name", "EmployeeName", 'actions'];
    }
    UsersRolesListComponent.prototype.ngOnInit = function () {
        this.getAllROLes();
    };
    UsersRolesListComponent.prototype.getAllROLes = function () {
        var _this = this;
    ...
    UsersRolesListComponent.prototype.onSearchClear = function () {
        this.searchKey = "";
        this.applyFilter();
    };
    UsersRolesListComponent.prototype.applyFilter = function () {
        this.listData.filter = this.searchKey.trim().toLowerCase();
    };
    UsersRolesListComponent.prototype.onEdit = function (UserId) {
        var _this = this;
        var dialogConfig = new _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatDialogConfig"]();
        dialogConfig.autoFocus = true;
        dialogConfig.disableClose = true;
        ...
        this.dialog.open(_users_roles_form_users_roles_form_component__WEBPACK_IMPORTED_MODULE_4__["UsersRolesFormComponent"], dialogConfig).afterClosed().subscribe(function (res) {
            _this.getAllROLes();
        });
    };
    UsersRolesListComponent.ctorParameters = function () { return [
        { type: _shared_users_service__WEBPACK_IMPORTED_MODULE_2__["UsersService"] },
    ...
    return UsersRolesListComponent;
}());
